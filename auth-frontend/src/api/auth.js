// api/auth.js
import { AUTH_API_BASE_URL, AREA_API_BASE_URL, AUTH_API_PREFIX, AREA_API_PREFIX } from "./config";

const AUTH_BASE = `${AUTH_API_BASE_URL}${AUTH_API_PREFIX}`;
const AREA_BASE = `${AREA_API_BASE_URL}${AREA_API_PREFIX}`;
